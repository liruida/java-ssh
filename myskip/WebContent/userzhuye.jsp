				 ...
				 <div class="header-left">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="shop.html"><%=session.getAttribute("username")%>的主页</a></li>
						    	<li><a href="productlist">进入商店</a></li>
								<li><a href="experiance.html">我的购物车</a></li>
								<li><a href="contact.html">我的积分</a></li>	
								<li><a href="showCart">我的收藏</a></li>
							</ul>
