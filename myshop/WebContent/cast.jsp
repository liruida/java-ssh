...
<p>&nbsp</p>
   <div id=a>
                   <c:forEach items="${showcartobject }" var="show" >
						<form:form action="/myshop/cart/cast" commandName="paycart"
							method="post">
							
							
		用户id:  <form:input path="id" />${show.id}
							<form:errors path="id" />
							<br>
		产品名称：<form:input path="productname"/>${show.productname}
							<form:errors path="productname" />
							<br>
				
		产品单价：<form:input path="price" />${show.price}
							<form:errors path="price" />
							<br>
		产品数量：<form:input path="count" />${show.count}
							<form:errors path="count" />
							<br>
							<input type="submit" value="结算" />
							<li><a href="/myshop/cart/cast">不结算但加入购物车</a></li>
							<br>
						</form:form>
						<p>&nbsp</p>
						<p>&nbsp</p>
						...
						<script type="text/javascript"
							src="${ctx }/static/js/responsive-nav.js"></script>
					</div>
					<div class="clear"></div>
				</div>
						...
						<li><a class="active-icon c1" href="#"> </a>
							<ul class="sub-icon1 list">
								<div class="product_control_buttons">
									<a href="#"><img src="${ctx }/static/images/edit.png"
										alt="" /></a> <a href="#"><img
										src="${ctx }/static/images/close_edit.png" alt="" /></a>
								</div>
								<div class="clear"></div>
								<li class="list_img"><img src="${ctx }/static/images/1.jpg"
									alt="" /></li>
								<li class="list_desc"><h4>
										<a href="#"></a>
									</h4> <span class="actual">1 x </span></li>
