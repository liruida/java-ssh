      ...
      <div class="shop_top">
		<div class="container">
			<div class="row shop_box-top">
				...
				<a href="productdetails?id=${p.id }">	<img src="${ctx }/static/images/pic5.jpg" class="img-responsive" alt=""/>
					<span class="new-box">
					...
					<div class="shop_desc">
						...
						<ul class="buttons">
					 		<li class="cart"><a href="/myshop/cart/addtocart?productId=${p.id }">加入购物车</a></li>
