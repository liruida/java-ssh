					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  <div class="product_control_buttons">
						  	<a href="#"><img src="static/images/edit.png" alt=""/></a>
						  		<a href="#"><img src="static/images/close_edit.png" alt=""/></a>
						  </div>
						   <div class="clear"></div>
				...
				<div class="row footer_bottom">
				    <div class="copy">
					  ...
					  <dl id="sample" class="dropdown">
				        ...
				        <dd>
				            <ul>
				                <li><a href="#">澳大利亚<img class="flag" src="static/images/as.png" alt="" /><span class="value">AS</span></a></li>
				                <li><a href="#">斯里兰卡<img class="flag" src="static/images/srl.png" alt="" /><span class="value">SL</span></a></li>
				                <li><a href="#">新西兰<img class="flag" src="static/images/nz.png" alt="" /><span class="value">NZ</span></a></li>
				                <li><a href="#">巴基斯坦<img class="flag" src="static/images/pk.png" alt="" /><span class="value">Pk</span></a></li>
				                <li><a href="#">联合国<img class="flag" src="static/images/uk.png" alt="" /><span class="value">UK</span></a></li>
				                <li><a href="#">美国<img class="flag" src="static/images/us.png" alt="" /><span class="value">US</span></a></li>
				            </ul>
				         </dd>
	   				  </dl>
   				</div>
