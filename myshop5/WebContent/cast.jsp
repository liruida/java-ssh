...
>
							...
							<span>产品数量<label></label></span> <input type="text" name="count" value=${show.count}>
							
						</div>
                         <div class="center-block">
						<input type="submit" value="结算" />
						<li><a href="/myshop/cart/cast">删除</a></li> <br></div>
			...
			<li><a class="active-icon c1" href="#"> </a>
				<ul class="sub-icon1 list">
					<div class="product_control_buttons">
						...
						<a href="#"><img src="${ctx }/static/images/close_edit.png"
							alt="" /></a>
					</div>
					<div class="clear"></div>
